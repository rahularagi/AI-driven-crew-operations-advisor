...
def test_on_leg_completed_increments_flight_hours():
    ...
    with patch("crew_ops_backend.clients.flight_schedule_client.get_flight_leg", return_value=mock_leg), \
         patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.get_crew_duty_state", return_value=ftl), \
         patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.get_crew_member", return_value=mock_crew), \
         patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.update_crew_duty_state",
...
def test_on_leg_completed_skips_crew_with_no_ftl():
    ...
    mock_leg.scheduled_arrival   = _now()
    with patch("crew_ops_backend.clients.flight_schedule_client.get_flight_leg", return_value=mock_leg), \
         patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.get_crew_duty_state", return_value=None), \
         patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.update_crew_duty_state") as mock_update:
        svc.on_leg_completed(_leg_completed_event())
...
def test_on_leg_completed_calls_update_for_each_crew():
    ...
    updated = []
    with patch("crew_ops_backend.clients.flight_schedule_client.get_flight_leg", return_value=mock_leg), \
         patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.get_crew_duty_state",
...
def test_on_roster_modified_removed_crew_set_unavailable():
    ...
    updated = []
    with patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.get_crew_duty_state", return_value=ftl), \
         patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.update_crew_duty_state",
               side_effect=lambda f: updated.append(f)):
...
def test_on_roster_modified_skips_missing_ftl():
    svc = FlightTimeLimitsService()
    with patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.get_crew_duty_state", return_value=None), \
         patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.update_crew_duty_state") as mock_update:
...
def test_proactive_scan_duty_period_approaching_alert():
    ...
    published = []
    with patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.get_all_crew_duty_states",
               return_value=[ftl]), \
         patch("crew_ops_backend.services.flight_time_limits.flight_time_limits_service.event_bus") as mock_bus:
